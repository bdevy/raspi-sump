...
from raspisump import reading, storage
...
use_csv = config.getint('storage', 'use_csv')
use_zabbix = config.getint('storage', 'use_zabbix')
use_influxdb = config.getint('storage', 'use_influxdb')
